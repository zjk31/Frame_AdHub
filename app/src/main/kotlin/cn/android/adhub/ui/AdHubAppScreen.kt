...
import cn.android.adhub.ui.components.AppUpdateDialog
import cn.android.adhub.ui.navigation.MangaNavHost
import cn.android.adhub.ui.navigation.MangaNavRoutes
...
private fun MangaAppContent() {
    ...
    val appUpdateChecker: cn.android.adhub.data.update.AppUpdateChecker = koinInject()
