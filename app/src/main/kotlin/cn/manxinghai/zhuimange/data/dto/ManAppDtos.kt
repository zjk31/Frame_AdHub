package cn.manxinghai.zhuimange.data.dto
...
data class MangaMostReadDto(
    @SerializedName("id") val id: String,          // API 返回 String 类型
    @SerializedName("title") val name: String?,     // API 字段名是 title
    @SerializedName("author") val author: String?,
    @SerializedName("coverUrl") val coverUrl: String?,
    @SerializedName("tags") val tags: String?,      // JSON 数组字符串 "[\"冒险\",\"热血\"]"
    ...
    @SerializedName("latestChapter") val latestChapter: Int?,
...
data class MangaDetailDto(
    @SerializedName("id") val id: String,             // API 返回 String
    @SerializedName("title") val name: String?,        // API 字段名是 title
    @SerializedName("author") val author: String?,
    @SerializedName("coverUrl") val coverUrl: String?,
    @SerializedName("tags") val tags: String?,          // JSON 数组字符串
    ...
    @SerializedName("chapters") val chapterList: List<ChapterBriefDto>?
)

data class ChapterBriefDto(
    @SerializedName("id") val id: String,             // API 返回 String
    @SerializedName("title") val name: String?,        // API 字段名是 title
    @SerializedName("chaporder") val chapterIndex: String?  // API 字段名是 chaporder
)

data class MangaChapterVo(
    @SerializedName("id") val id: String,
    @SerializedName("title") val name: String?,        // API 字段名是 title
    @SerializedName("chapOrder") val chapterIndex: Int?,
    @SerializedName("mangaId") val mangaId: String,
    @SerializedName("prefix") val prefix: String?,
    @SerializedName("picList") val picList: List<String>?  // 直接是图片 URL 数组
)
