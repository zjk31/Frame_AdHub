package cn.maga.lingdongmanhua.core
...
class HotStartInterstitialManager(
    ...
    private val pureModeManager: cn.maga.lingdongmanhua.core.PureModeManager,
) {

    companion object {
        private const val TAG = "HotStartInterstitial"
        private const val MIN_INTERVAL_MS = 600_000L  // 两次插屏最少间隔 600 秒（10 分钟）
